...
func TestMap(t *testing.T) {
	...
	intArrayResult, err := Map(intArray, double)
	...
	floatArrayResult, err := Map(floatArray, doubleFloat)
	...
	uIntArrayResult, err := Map(uIntArray, doubleUInt)
	...
	stringArrayResult, err := Map(stringArray, addBug)
